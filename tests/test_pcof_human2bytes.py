...
@pytest.mark.parametrize("size, unit, result", [
    (1, "KB", "1024.00"),
    (1, "MB", "1048576.00"),
    (1, "GB", "1073741824.00"),
...
@pytest.mark.parametrize("size, unit, precision, result", [
    (1, "KB", 0, "1024"),
    (2, "GB", 0, "2147483648"),
    (2, "GB", 1, "2147483648.0"),
...
@pytest.mark.parametrize("size, unit, base, result", [
    (1, "KB", 1000, "1000.00"),
...
def test_human2bytes_raise():
    ...
    with pytest.raises(ValueError, match="invalid unit. It must be KB, MB, GB, TB, PB, EB, ZB"):
